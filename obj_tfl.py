...
Original file is located at
    https://colab.research.google.com/drive/1-nBBA1V588Aegp2SNwX7bVQrJESMU-zK
"""
...
interpreter = tf.lite.Interpreter(model_path="/home/pi/mlcodes/Gisha_05/180model.tflite")           # Interpreter interface for running TensorFlow Lite models.
interpreter.allocate_tensors()                           # tflite_model can be saved to a file and loaded later, or directly into the Interpreter.
...
while True:
    ...
    interpreter.invoke()                                                   # this is the predict function similar to keras
